...
<div class="container my-5" style="min-height: 90vh;">
    <div class="rounded p-3 mb-5" style="background-color:#C0392B ;">
        <div class="d-flex align-items-center justify-content-center ms-3">
            <span class="text-light fs-2 fw-bold">Total of expired drugs</span>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form class="d-flex" method="GET" action="">
                ...
                <a class="btn btn-danger px-5 ms-1" role="button" href="./expire.php?search=">Clear</a>
            </form>
        </div>
    </div>
